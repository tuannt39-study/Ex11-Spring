...
public class BaiVietAPI {
	...
	//http://localhost:8080/Ex11/api
	@GetMapping("/api")
	public String welcome() {
		return "Spring Rest";
	}

	//http://localhost:8080/Ex11/api/baiviet
	@GetMapping("/api/baiviet")
	public String bietViet() {
		return "Spring Rest Bai Viet";
	}

	// http://localhost:8080/Ex11/api/baiviet/all
	...
	// http://localhost:8080/Ex11/api/baiviet/4
	...
	// http://localhost:8080/Ex11/api/baiviet/create
	// {
	...
	// http://localhost:8080/Ex11/api/baiviet/update/8
	// {
	// "maBV": 8,
	...
	// http://localhost:8080/Ex11/api/baiviet/delete/6
	...
	// http://localhost:8080/Ex11/api/baiviet/delete/all
